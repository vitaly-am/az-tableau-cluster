...
#installation
sudo ./automated-installer.sh -a $tsm_admin_user -f /dev/zero -r /dev/zero -s /tmp/secrets.properties -b bootstrap.cfg -v --accepteula --force /tmp/tableau-installer.rpm --debug
